...
#
#  $ bin/test -s redturtle.faq -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src redturtle.faq.testing.REDTURTLE_FAQ_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/redturtle/faq/tests/robot/test_example.robot
#
